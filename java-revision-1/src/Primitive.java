public class Primitive {
  public static void main(String[] args) {
    ...
    //compier check if 10 can be assigned to x

    long l = x;//long range is higher than int range value (promotion / upcast)
    short s = (short) x;//short range is lower than int type (downcast -> explicit casting)
    //As a developer,you dicided to adopt the risk of precision loss
