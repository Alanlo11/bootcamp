...
public class DemoLambda {
  public static void main(String[] args) {
    ...
    // Another Object
    person = () -> System.out.println("i am swimming!!!");// DemoLambda$$Lambda$2/0x0000007001001800@18b4aac2
    ...
    // then you have to use "return" ketword within the implemention block
    ...
    System.out.println(nameLength.apply(new Customer("John")));// 4
    Function<Customer, String> name = customer -> customer.getName();
    System.out.println(name.apply(new Customer("Alan")));// Alan
    ...
    BiPredicate<String, String> isNameTooLong2 = (s1, s2) -> s1.length() + s2.length() > 9;
    System.out.println(isNameTooLong2.test("Vincent", "Lau"));// true


    BiPredicate<String, String> longerName = (s1, s2) -> s1.length() > s2.length();
    System.out.println(longerName.test("Vincent", "Alan"));// true
